...
| [`audio`](recode.audio.md#module-recode.audio)   | Encoding audio                       |
|------------------------------------------------------------------------------|--------------------------------------|
| [`base`](recode.base.md#module-recode.base)     | Base recode objects                  |
| [`util`](recode.util.md#module-recode.util)     | Utils for use throughout the package |
